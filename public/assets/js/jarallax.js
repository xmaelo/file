            ...
            8: function (e, t, n) {
                ...
                function d() {
                    g = l
                        ? (!r &&
                              document.body &&
                              (((r = document.createElement("div")).style.cssText = "position: fixed; top: -9999px; left: 0; height: 100vh; width: 0;"),
                        ...
                        return (
                            ...
                            (t = [
                                ...
                                },
                                {
                                    key: "getWindowData",
                                    value: function () {
                                        return { width: f.window.innerWidth || document.documentElement.clientWidth, height: g, y: document.documentElement.scrollTop };
                                    },
                                },
                                {
                                    key: "initImg",
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        ...
                                        t.options.keepImg ||
                                            ...
                                            ("opacity" !== t.options.type && "scale" !== t.options.type && "scale-opacity" !== t.options.type && 1 !== t.options.speed) ||
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        ...
                                        s.options.elementInViewport && (d = s.options.elementInViewport.getBoundingClientRect()),
                                            (s.isElementInViewport = 0 <= d.bottom && 0 <= d.right && d.top <= g && d.left <= f.window.innerWidth),
                                            (e || s.isElementInViewport) &&
                                                ...
                                                ("opacity" !== s.options.type && "scale-opacity" !== s.options.type && "scroll-opacity" !== s.options.type) ||
    ...
    !(function () {
        ...
        (i.window.jarallax = a.default),
            ...
            void 0 !== i.jQuery &&
                ...
                (n = i.jQuery.fn.jarallax),
                (i.jQuery.fn.jarallax = e),
