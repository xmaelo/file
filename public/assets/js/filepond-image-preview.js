    ...
    var n = function (e, t) {
        ...
        y = {
            ...
            text: function (e, t, i, r) {
                ...
                l(e, Object.assign({}, e.rect, e.styles, { "stroke-width": 0, "font-weight": o, "font-size": a, "font-family": n, "text-anchor": c })),
                ...
                if ((l(a, { x1: f.x, y1: f.y, x2: p.x, y2: p.y }), t.lineDecoration)) {
                    ...
                    if (-1 !== t.lineDecoration.indexOf("arrow-end")) {
                        var _ = n(g, -m),
                            ...
                            M = c(p, 2, I),
                            x = c(p, -2, I);
                        l(d, { style: "display:block;", d: "M".concat(M.x, ",").concat(M.y, " L").concat(p.x, ",").concat(p.y, " L").concat(x.x, ",").concat(x.y) });
                    }
                }
            },
        },
        ...
        P = function (e, t) {
            var i = e.width,
                r = i * t;
            return r > e.height && (i = (r = e.height) / t), { x: 0.5 * (e.width - i), y: 0.5 * (e.height - r), width: i, height: r };
        },
        C = function (e) {
        ...
        D = function (e) {
            return e.utils.createView({
                            ...
                            (function (e) {
                                return e.utils.createView({
                                    ...
                                    mixins: {
                                        ...
                                        animations: { originX: k, originY: k, scaleX: k, scaleY: k, translateX: k, translateY: k, rotateZ: k },
                                    },
                                    create: function (t) {
                                        var i = t.root,
                                            r = t.props;
                ...
                write: function (e) {
                    ...
                    var v = t.ref.image;
                    if (r)
                        return (v.originX = null), (v.originY = null), (v.translateX = null), (v.translateY = null), (v.rotateZ = null), (v.scaleX = null), void (v.scaleY = null);
            ...
            var t = e.utils.createView({
                    ...
                    return e.utils.createView({
                        ...
                        create: function (t) {
                            ...
                            i.ref.clip = i.appendChildView(
                                i.createChildView(D(e), { id: r.id, image: r.image, crop: r.crop, markup: r.markup, resize: r.resize, dirty: r.dirty, background: r.background })
                            );
                        },
                        write: function (e) {
                            var t = e.root,
                ...
                n = function (e) {
                    ...
                    if (o) {
                        var c,
                            s,
                            h = o.getMetadata("crop") || { center: { x: 0.5, y: 0.5 }, flip: { horizontal: !1, vertical: !1 }, zoom: 1, rotation: 0, aspectRatio: null },
            ...
            return e.utils.createView({
                ...
                create: function (e) {
                    ...
                    (i.ref.images = []),
                        ...
                        (i.ref.overlaySuccess = i.appendChildView(i.createChildView(t, { opacity: 0, status: "success" }))),
                ...
                write: e.utils.createRoute(
                    {
                        ...
                        DID_FINISH_CALCULATE_PREVIEWSIZE: function (e) {
                            ...
                            if (c) {
                                ...
                                if (
                                    ((s = c.file),
                                    !(((h = window.navigator.userAgent.match(/Firefox\/([0-9]+)\./)) ? parseInt(h[1]) : null) <= 58) && "createImageBitmap" in window && L(s))
                                ) {
                                    var f = r(V);
                                                ...
                                                !(function (e) {
                                                    ...
                                                    if (r) {
                                                        ...
                                                        (a.crop = r.getMetadata("crop")),
                                                            (a.background = t.query("GET_IMAGE_TRANSFORM_CANVAS_BACKGROUND_COLOR")),
                                                            t.query("GET_IMAGE_PREVIEW_MARKUP_SHOW") &&
                                                                ((a.dirty = !0), (a.resize = r.getMetadata("resize")), (a.markup = r.getMetadata("markup")));
                                                    }
                                                })({ root: t, props: i });
                                        }
                                        var l, d;
