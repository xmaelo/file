var tns = (function () {
    ...
    var $i = function (H) {
        ...
        if (
            ...
            $ || $e(Kt || _t),
                ...
                (function () {
                    ...
                    (Xt += " tns-" + H.axis),
                        (V.className += Xt),
                        I ? (((M = O.createElement("div")).id = Yt + "-mw"), (M.className = "tns-ovh"), T.appendChild(M), M.appendChild(j)) : T.appendChild(j);
                    if (dt) {
                        var t = M || j;
                        t.className += " tns-ah";
                    }
        ...
        function bn() {
            if (
                ...
                T.insertAdjacentHTML(
                    "afterbegin",
                    '<div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span class="current">' + Hn() + "</span>  of " + Q + "</div>"
                ),
                ...
                je
                    ...
                    : H.autoplayButtonOutput &&
                      (T.insertAdjacentHTML(on(H.autoplayPosition), '<button type="button" data-action="' + t + '">' + Ge[0] + t + Ge[1] + bt[0] + "</button>"),
        ...
        function ni(t, e) {
            Ht && _e(),
                (It !== Pt || e) &&
                    (Qt.emit("indexChanged", Ei()), Qt.emit("transitionStart", Ei()), dt && Pn(), Pe && t && 0 <= ["click", "keydown"].indexOf(t.type) && fi(), (Vt = !0), Ze());
        }
        function ii(t) {
