...
@section('title')
Purchased Single Vehicle | Accounts
@endsection
...
<div class="container mt-5 pt-5">
    <nav class="pt-md-3 mb-3" aria-label="Breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Purchased single vehicle</li>
        </ol>
    </nav>
</div>
<section class="pb-lg-4 container mt-3 mb-4 pt-3">
    <div class="d-sm-flex align-items-end align-items-md-center justify-content-between position-relative mb-4" style="z-index: 1025;">
        <div class="me-3">
            <h1 class="h2 mb-md-0">{{$car->brand}} {{$car->body_type}} {{$car->model}}</h1>
            <div class="d-md-none">
                <div class="mb-2">
